...
const (
	CallbackType_CB_COMMAND CallbackType = 0
	CallbackType_CB_HTTP    CallbackType = 1
	CallbackType_CB_FILE    CallbackType = 2
)
...
func (x *FileCallback) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FileCallback) ProtoMessage() {}

func (x *FileCallback) ProtoReflect() protoreflect.Message {
	mi := &file_callback_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FileCallback.ProtoReflect.Descriptor instead.
func (*FileCallback) Descriptor() ([]byte, []int) {
	return file_callback_proto_rawDescGZIP(), []int{2}
}

func (x *FileCallback) GetPath() string {
	if x != nil {
		return x.Path
	}
	return ""
...
func (x *Callback) GetType() CallbackType {
	...
	return CallbackType_CB_COMMAND
}
...
var file_callback_proto_rawDesc = []byte{
	...
	0x22, 0x39, 0x0a, 0x0f, 0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x43, 0x61, 0x6c, 0x6c, 0x62,
	...
	0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x04, 0x61, 0x72, 0x67, 0x73, 0x22, 0x92, 0x01, 0x0a, 0x0c,
	0x48, 0x74, 0x74, 0x70, 0x43, 0x61, 0x6c, 0x6c, 0x62, 0x61, 0x63, 0x6b, 0x12, 0x10, 0x0a, 0x03,
	0x75, 0x72, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x75, 0x72, 0x6c, 0x12, 0x34,
	0x0a, 0x07, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x1a, 0x2e, 0x48, 0x74, 0x74, 0x70, 0x43, 0x61, 0x6c, 0x6c, 0x62, 0x61, 0x63, 0x6b, 0x2e, 0x48,
	...
	,
...
var file_callback_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_callback_proto_goTypes = []interface{}{
	(CallbackType)(0),       // 0: CallbackType
	(*CommandCallback)(nil), // 1: CommandCallback
	(*HttpCallback)(nil),    // 2: HttpCallback
	(*FileCallback)(nil),    // 3: FileCallback
	(*Callback)(nil),        // 4: Callback
	nil,                     // 5: HttpCallback.HeadersEntry
}
var file_callback_proto_depIdxs = []int32{
	5, // 0: HttpCallback.headers:type_name -> HttpCallback.HeadersEntry
